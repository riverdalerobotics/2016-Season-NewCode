...
public class ChassisSubsystem extends Subsystem {
	...
	Encoder rightEncoder = new Encoder(RobotMap.EncoderMap.RIGHT_ONE.getPort(),
			RobotMap.EncoderMap.RIGHT_TWO.getPort());
	...
	public double PIDController(double inSpeed) {

		// inSpeed inDistance = encoders average error = inDistance - distance
		// travelled       error* speed * pid

		double error = getDistance();
		//TODO: PID In progress
		
		return inSpeed * RobotMap.PID_ERROR_MULTIPLIER;
